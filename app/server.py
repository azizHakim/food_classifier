...
export_file_url = 'https://www.googleapis.com/drive/v3/files/1-7iKb6pgvzjZxN8UkNLlVb_0QwwNSIVU?alt=media&key=AIzaSyDXxCebR-0uhaDCWZHTaYNb7EthGLr_Rnw'
export_file_name = 'res50_20.pkl'
